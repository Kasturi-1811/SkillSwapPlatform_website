...
class LogoutGetPostView(LogoutView):
...
urlpatterns = [
    ...
    # Use default LogoutView - supports only GET by default, which is fine for logout link
    path('logout/', LogoutGetPostView.as_view(next_page='home'), name='logout'),
